...
const Contact = () => {
    // JSX templates
    return (  
        <div role="region" className="w-full h-max mt-20 relative bg-white md:mt-28">
            ...
            <div className="w-full h-max mt-16 md:mt-20">
                ...
                <div className="flex items-center mt-7 px-2">
                    {/** Github */}
                    <a href={ socialMedia['links'].github } className="mr-3 xs:mr-4">
                        {/** Github icon */}
                        <img src={ socialMedia['icons'].github } alt="Github" className="h-6 object-contain xs:h-7 md:h-8"/>
                    </a>
                    {/** Linkedin */}
                    <a href={ socialMedia['links'].linkedin } className="mr-3 xs:mr-4">
                        {/** Linkedin icon */}
                        <img src={ socialMedia['icons'].linkedin } alt="LinkedIn" className="h-6 object-contain xs:h-7 md:h-8"/>
                    </a>
                    {/** Twitter */}
                    <a href={ socialMedia['links'].twitter } className="mr-3 xs:mr-4">
                        {/** Twitter icon */}
                        <img src={ socialMedia['icons'].twitter } alt="Twitter" className="h-6 object-contain xs:h-7 md:h-8"/>
                    </a>
                     {/** Facebook */}
                    <a href={ socialMedia['links'].facebook }>
                         {/** Facebook icon */}
                        <img src={ socialMedia['icons'].facebook } alt="Facebook" className="h-6 object-contain xs:h-7 md:h-8"/>
                    </a>
                </div>
            </div>
        </div>
